      ...
      <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statItem}>
              <MaterialCommunityIcons
                name={isFull ? 'close-circle-outline' : 'check-circle-outline'}
                size={14}
                color={barColor}
              />
          ...
          {hostel.amenities && hostel.amenities.length > 0 && (
            <View style={styles.amenities}>
              {hostel.amenities.slice(0, 4).map((a) => (
                <View key={a} style={[styles.amenityTag, { backgroundColor: theme.colors.surfaceVariant }]}>
              ...
              {hostel.amenities.length > 4 && (
                <View style={[styles.amenityTag, { backgroundColor: theme.colors.surfaceVariant }]}>
                  <Text style={[styles.amenityText, { color: theme.colors.onSurfaceVariant }]}>
                    +{hostel.amenities.length - 4}
                  </Text>
                </View>
