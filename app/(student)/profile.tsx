              ...
              <>
                {[
                  ...
                  <View key={field.label}>
                    <View style={styles.field}>
                      <Text style={[styles.fieldLabel, dynTextSec]}>{field.label}</Text>
                      <Text style={[styles.fieldValue, dynText]}>{field.value || '—'}</Text>
                    </View>
          ...
          <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert(
                  'About StayHub',
                  `StayHub Mobile\nVersion ${APP_CONFIG.VERSION}\n\nA smart hostel reservation platform for students. Book your room, manage reservations, and pay seamlessly — all in one place.`
                )
              }
            >
