...
export default function PaymentScreen() {
  ...
  // Amount to display — prefer status.amount (already verified), fall back to amountDue
    ...
    <View style={[styles.screen, { backgroundColor: theme.colors.background }]}>
      ...
      >
        ...
        <View style={styles.hero}>
          ...
          {status?.paidAt && (
            <Text style={styles.heroPaidDate}>
        ...
        {!error && !isPaid && (
          <View style={styles.section}>
            ...
            <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
              ...
              <TouchableOpacity
                style={[styles.primaryBtn, styles.fullBtn, initializing && { opacity: 0.7 }]}
